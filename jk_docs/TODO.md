...
### Deployments Page
- **Rerun deployment (Azure DevOps-style)**
...
### Pipelines (UI / IA)
- **Consolidate Pipelines page into Deployments page**
...
### Observability Page
- **Make fully functional using existing data**
...
### Credentials Page
- **Fix credentials sync showing zero**
...
## Snapshot Mutability Policy (Implementation TODO)
...
## Snapshot Mutability Policy (Per-Environment)
